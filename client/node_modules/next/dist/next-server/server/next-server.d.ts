...
import { Header, Redirect, Rewrite } from 'next/dist/lib/check-custom-routes';
...
export default class Server {
    ...
    protected staticPathsWorker?: import('next/dist/next-server/server/node_modules/jest-worker').default & {
        loadStaticPaths: typeof import('next/dist/server/static-paths-worker').loadStaticPaths;
    };
